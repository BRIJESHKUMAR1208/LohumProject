...
const GalleryEdit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    submissionData.append("action", "creatorupdate");
        ...
        <div className="pagetitle-lft">
          <nav>
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active">Edit Gallery Update</li>
            </ol>
            <h1 className="text-center heading-main">Edit Gallery Update</h1>
          </nav>
          </div>
