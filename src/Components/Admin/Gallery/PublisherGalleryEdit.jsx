...
const PublisherGalleryEdit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    submissionData.append("action", "publish");
        ...
        <div className="pagetitle-lft">
          <nav>
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active">Publisher Gallery Update</li>
            </ol>
            <h1 className="text-center heading-main">Publisher Gallery Update</h1>
          </nav>
          </div>
...
export default PublisherGalleryEdit;
