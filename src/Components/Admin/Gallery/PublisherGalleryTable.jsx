...
const PublisherGalleryTable = () => {
...

    {
      ...
      renderCell: (params) =>
        usertype === 2 || usertype === 4 ? (
          <Link to={"/PublisherGalleryEdit/" + params.row.id}>
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await APIClient.get(apis.gallerypublisherlist);
...
export default PublisherGalleryTable;
