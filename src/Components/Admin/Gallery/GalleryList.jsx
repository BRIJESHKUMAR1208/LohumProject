...
const GalleryList = () => {
    ...
    { field: "title", headerName: "Title", width: 200 },
    {
      ...
      renderCell: (params) =>
        usertype === 1 || usertype === 4 ? (
          <Link to={"/GalleryEdit/" + params.row.id}>
  ...
  const handleConfirmSubmit = async () => {
    try {
      await APIClient.post("/api/Gallery/delete/" + selectedItem.id);
      setApiData((prevData) =>
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await APIClient.get(apis.gallerylist);
      ...
      <main id="main" className="main">
          ...
          <div className="pagetitle-lft">
            ...
            <nav>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active">Gallery Table</li>
              </ol>
            </nav>
            <h1>All Gallery</h1>
          </div>
        ...
        >
          ...
          <Button
            ...
            color="secondary"
            component={Link}
            to="/PublisherGalleryTable"
          >
            Gallery Publisher List
          </Button>
        </Box>
        </div>
