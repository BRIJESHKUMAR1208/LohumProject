...
const PublishList = () => {
    ...
    { field: "content", headerName: "Content Data", width: 200 },
    {
      ...
      renderCell: (params) =>
        usertype === 1 || usertype === 4 ? (
          <Link to={"/logoSlider/EditPublishLogo/" + params.row.id}>
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await APIClient.get(apis.getpublishlist);
          ...
          <main id="main" className="main">
            <nav>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item">Logo Table</li>
                <li className="breadcrumb-item active">Logo Publish Table </li>
              </ol>
            </nav>
            <h1 className="maintitle">Logo Publish Table</h1>
